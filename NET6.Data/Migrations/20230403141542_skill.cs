    ...
    public partial class skill : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16ea936c-7a28-4c30-86a2-9a9704b6115e"), "43e47448-bbb6-4a42-b1d4-9300a0b0a51b", "Superadmin", "SUPERADMIN" },
                    { new Guid("7cb750cf-3612-4fb4-9f7d-a38ba8f16bf4"), "403d75d7-c15e-4b76-b07c-88198a8f64eb", "Admin", "ADMIN" },
                    { new Guid("edf6c246-41d8-475f-8d92-41dddac3aefb"), "58e1059d-131f-4a8e-8816-559160fef27c", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1266ee22-b956-4fd2-bcd1-fa55d33a77da"), "Admin Test", new DateTime(2023, 4, 3, 17, 15, 42, 13, DateTimeKind.Local).AddTicks(5427), null, null, false, null, null, "Design" },
                    { new Guid("1bd1d873-a5ff-43e1-aa04-f86dd78495ee"), "Admin Test", new DateTime(2023, 4, 3, 17, 15, 42, 13, DateTimeKind.Local).AddTicks(5421), null, null, false, null, null, "Coding" },
                    { new Guid("4c569a9a-5f41-478f-9d17-69ac5b02ae0b"), "Admin Test", new DateTime(2023, 4, 3, 17, 15, 42, 13, DateTimeKind.Local).AddTicks(5406), null, null, false, null, null, "ASP.NET Core" },
                    { new Guid("d23e4f79-9600-4b5e-b3e9-756cdcacd2b1"), "Admin Test", new DateTime(2023, 4, 3, 17, 15, 42, 13, DateTimeKind.Local).AddTicks(5414), null, null, false, null, null, "Visual Studio 2022" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"), "Admin Test", new DateTime(2023, 4, 3, 17, 15, 42, 13, DateTimeKind.Local).AddTicks(6173), null, null, "images/vstest.jpg", "png", false, null, null },
                    { new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"), "Admin Test", new DateTime(2023, 4, 3, 17, 15, 42, 13, DateTimeKind.Local).AddTicks(6165), null, null, "images/testimage.jpg", "jpg", false, null, null }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "ImageId", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("3aa42229-1c0f-4630-8c1a-db879ecd0427"), 0, "9029d558-810c-4322-a4ac-811070b24fd6", "admin@gmail.com", false, "Admin", new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"), "User", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEMWRyC8LR9Au8OjC0dNTZVUnGRw2Z91DTrMCzjOhVtQLg1slwFS4LR5mtLEa6DV4aw==", "+905439999988", false, "233dee2c-19ed-4d56-9389-833a667e3650", false, "admin@gmail.com" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "ImageId", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("cb94223b-ccb8-4f2f-93d7-0df96a7f065c"), 0, "54ff886d-aef5-40ad-ae95-a703233c4f6b", "superadmin@gmail.com", true, "Batuhan", new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"), "Ulukan", false, null, "SUPERADMIN@GMAIL.COM", "SUPERADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEDRRlXV7dcz0faxJ5NqNOtRMZhnaBpbytQPNui8Tvu3moCMk6xMmKyRw1eLLzwn7mA==", "+905439999999", true, "38487222-26f6-4a3e-a926-c4b9b02ae768", false, "superadmin@gmail.com" });
