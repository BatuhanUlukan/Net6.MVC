...
{
    public partial class addedlayer : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Portfolios_Links_LinkId",
                        column: x => x.LinkId,
                        principalTable: "Links",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Portfolios_Seos_SeoId",
                        column: x => x.SeoId,
                        principalTable: "Seos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Processes_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16ea936c-7a28-4c30-86a2-9a9704b6115e"), "734b22aa-7523-4ed9-a83e-d1bfb109bcb2", "Superadmin", "SUPERADMIN" },
                    { new Guid("7cb750cf-3612-4fb4-9f7d-a38ba8f16bf4"), "4e28bd29-7954-423c-a0d8-83bbd411f114", "Admin", "ADMIN" },
                    { new Guid("edf6c246-41d8-475f-8d92-41dddac3aefb"), "c0bcffe9-b12c-402c-b84c-05c4f53576a6", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1266ee22-b956-4fd2-bcd1-fa55d33a77da"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(54), null, null, false, null, null, "Design" },
                    { new Guid("1bd1d873-a5ff-43e1-aa04-f86dd78495ee"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(8), null, null, false, null, null, "Coding" },
                    { new Guid("2864cc7d-73fe-47b9-a5b1-bb58f6046d5c"), "Admin", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(61), null, null, false, null, null, "Work" },
                    { new Guid("4c569a9a-5f41-478f-9d17-69ac5b02ae0b"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 759, DateTimeKind.Local).AddTicks(9989), null, null, false, null, null, "ASP.NET Core" },
                    { new Guid("53bb0f44-9f0d-447b-9a18-84722b1abde5"), "Admin", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(68), null, null, false, null, null, "Education" },
                    { new Guid("d23e4f79-9600-4b5e-b3e9-756cdcacd2b1"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local), null, null, false, null, null, "Visual Studio 2022" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(1266), null, null, "images/vstest.jpg", "png", false, null, null },
                    { new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(1214), null, null, "images/testimage.jpg", "jpg", false, null, null }
                });

            migrationBuilder.InsertData(
                table: "Links",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "ModifiedBy", "ModifiedDate", "Name", "Url" },
                values: new object[,]
                {
                    { new Guid("49f708bf-48b1-4513-b8b0-0c087f6252af"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(1770), null, null, false, null, null, "Google", "www.google.com" },
                    { new Guid("8c68d329-a387-4e55-b04e-17fcad8cab47"), "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 760, DateTimeKind.Local).AddTicks(1762), null, null, false, null, null, "Instagram", "www.instagram.com" }
                });

            migrationBuilder.InsertData(
                table: "Seos",
                columns: new[] { "Id", "Author", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Description", "IsDeleted", "Keywords", "ModifiedBy", "ModifiedDate" },
                values: new object[,]
                {
                    { new Guid("59d9a438-3e21-4163-a42d-a13003d76831"), "ASP.NET Core", "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 762, DateTimeKind.Local).AddTicks(4890), null, null, "ASP.NET Core", false, "ASP.NET Core", null, null },
                    { new Guid("a7f5670d-31eb-4eea-ba51-a5e924135542"), "ASP.NET Core", "Admin Test", new DateTime(2023, 4, 17, 18, 41, 45, 762, DateTimeKind.Local).AddTicks(4916), null, null, "ASP.NET Core", false, "ASP.NET Core", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3aa42229-1c0f-4630-8c1a-db879ecd0427"), 0, "37fe698c-b4a7-4450-a278-830f0807e75a", "admin@gmail.com", false, "Admin", new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"), "User", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEJwE5+cLncptzHW9xr11zEfcpDh7Evh15m4KAlD0CDEv2q4OyHLZBG3PLnM6r/JVqw==", "+905439999988", false, "a65dd848-81a8-4f60-ab94-9f835fd55c50", false, "admin@gmail.com" },
                    { new Guid("cb94223b-ccb8-4f2f-93d7-0df96a7f065c"), 0, "233a29cb-cbda-4254-b9a2-89dd2807b4b2", "superadmin@gmail.com", true, "Batuhan", new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"), "Ulukan", false, null, "SUPERADMIN@GMAIL.COM", "SUPERADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEL+ybgwgw4BvhIiupnogRpwJsK5JI7R5RxfxtC+JRdLV3nikOEbhkrMQfyCvCYd0Kw==", "+905439999999", true, "55ef8db3-9b10-4f49-8306-069df76438c2", false, "superadmin@gmail.com" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Portfolios_LinkId",
                table: "Portfolios",
                column: "LinkId");

            migrationBuilder.CreateIndex(
                name: "IX_Portfolios_SeoId",
                table: "Portfolios",
                column: "SeoId");
